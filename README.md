# oss-audit-24MIp10005

This is my Open Source Software lab repo for auditing **Git** on **Ubuntu 24.04 (WSL2)**.

I’m **Pragnya ** (`Pragnya reddy`, reg no `24MIp10005`). I wrote a few small shell scripts to pull basic system info, check package info, audit a couple of directories, and scan a log file for keyword matches.
...
From the repo directory (`https://github.com/addipragnyareddy0501/open-source-software.git`):
